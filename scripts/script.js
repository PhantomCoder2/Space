const userW= document.querySelector('#userW'); //INPUT LINE
const userS= document.querySelector('#Select01'); //UNIT
//PLANETS
...
const weigh = document.querySelector('.weigh');
